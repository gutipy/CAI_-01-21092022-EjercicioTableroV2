...
namespace ProyectoTableroV2.InterfazGrafica
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Tarea T1 = new TareaComun("Tarea Común 1", "En curso", DateTime.Now.AddDays(-14), 1, DateTime.Now.AddDays(-3));
            Tarea T2 = new TareaEspecial("Tarea Especial 1", "En curso", DateTime.Now.AddDays(-10), 2);
                ...
                while (_consolaActiva)
                {
                    ...
                    switch (_opcionMenu)
                    {
                        case "1":
                            ...
                            Listar(tableroElectronico, _estado, ref _resultado);
                            break;
                        case "2":
        ...
        public static void Listar(Tablero _tablero, string estado, ref string resultado)
        {
        ...
        public static void Agregar(Tablero tableroElectronico)
        {
            ...
            else if (_opcion == "2")
            {
                ...
                do
                {
                    Console.WriteLine("Ingrese la dificultad de la nueva tarea");
                    _dificultad = Console.ReadLine();
                    flag = FuncionValidacionDificultad(_dificultad, ref _dificultadValidada);
